...
Implementación de un sistema multiagente colaborativo basado en **LangGraph** para búsqueda y resumen de papers científicos. Corresponde a la **Clase III** (Sistemas Cognitivos y Agentes Autónomos) de la materia **NLP3 – CEIA, FIUBA**.

Este proyecto es una adaptación del repositorio oficial de la cátedra ([FIUBA-Posgrado-Inteligencia-Artificial/PLN3 — Teoria3](https://github.com/FIUBA-Posgrado-Inteligencia-Artificial/PLN3/tree/main/Teoria3)), modificado para ejecutarse **íntegramente en local con Ollama** (sin dependencias de Groq u otras APIs externas).
